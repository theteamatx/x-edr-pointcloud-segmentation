...
#ifndef MOBILITY_POINT_CLOUD_MEAN_SHIFT_SEGMENTATION_H_
#define MOBILITY_POINT_CLOUD_MEAN_SHIFT_SEGMENTATION_H_
...
#endif  // MOBILITY_POINT_CLOUD_MEAN_SHIFT_SEGMENTATION_H_
